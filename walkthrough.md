...
### Figure 6: Spatiotemporal Time-Lapse Cell Migration Evolution
Displays the predicted cell locations at multiple intermediate steps ($t = 0.0, 0.33, 0.67, 1.0$), demonstrating how the starting cell population morphs and flows continuously along the manifold.

![Figure 6: Time-lapse Evolution](results/fig6_time_evolution.png)

### Figure 7: Mean Shift Potential Attraction Field
Visualizes the reference embryonic tissue density contours alongside the negative gradients of the potential field (orange arrows), illustrating how boundary guidance attracts drifting trajectories back into the tissue manifold.

![Figure 7: Potential Field Guidance](results/fig7_potential_field.png)

### Figure 8: Biological Direction Alignment (RNA Velocity Alignment)
Compares the cosine similarity between the predicted PCA velocity and the biological RNA velocity vector directions. SpaLineage-OT yields a highly right-shifted positive distribution compared to baselines, validating the accuracy of our physics-prior constraints.

![Figure 8: Velocity Alignment](results/fig8_velocity_alignment.png)
